...
import { attribute, tagName, classNames, className } from '@ember-decorators/component';
...
export default class SquarePaymentFormApplePayButton extends Component {
   ...
   * @private
   */
  @attribute('aria-label') label = 'Pay with Apple Pay';
