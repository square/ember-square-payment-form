...
declare enum SquarePaymentFormStyledStyles {
    light = "light",
    dark = "dark"
}
/**
...
export default class SquarePaymentFormStyled extends Component {
     ...
     */
    style: SquarePaymentFormStyledStyles;
    /**
     ...
     * @private
     */
    readonly styledFormInputStyles: SqPaymentFormInputStyle[];
    /**
     * Checks if the form is to configured to accept any digital wallet payment methods
     * @private
     */
    readonly acceptDigitalWallets: boolean;
    /**
