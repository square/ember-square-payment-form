...
export default class SquarePaymentForm extends Component {
     ...
     *
     */
    shippingContactChanged?: (shippingContact: SqPaymentFormContact, done: (update: SqPaymentFormPaymentDetailsUpdate) => void) => void;
    /**
     ...
     *
     */
    shippingOptionChanged?: (shippingContact: SqPaymentFormContact, done: (update: SqPaymentFormPaymentDetailsUpdate) => void) => void;
    /**
     * Used to determine if Apple Pay is supported in the current environment.
     * @private
     */
    canShowApplePay: boolean;
    /**
     * Used to determine if Apple Pay is supported in the current environment.
     * @private
     */
    canShowGooglePay: boolean;
    /**
     * Used to determine if Apple Pay is supported in the current environment.
     * @private
     */
    canShowMasterpass: boolean;
    /**
     * Checks if the form is to configured to accept any digital wallet payment methods
     * @private
     */
    readonly canShowDigitalWallets: boolean;
    /**
